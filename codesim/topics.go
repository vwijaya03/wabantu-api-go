...
func TendemExamFormat() ExamFormat {
	return ExamFormat{
		...
		MixNotes: "50 hard MCQs (English) with code snippets where needed. Build/debug tasks use the hard Tendem bank. Hard sample rotations are mixed automatically.",
	}
}
